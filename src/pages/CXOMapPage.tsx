            ...
            <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className={`md:pl-4 lg:pl-8 xl:pl-12 transform transition-all duration-1000 ${heroVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
                <h1 className="text-4xl lg:text-6xl font-extrabold leading-tight text-white">
                  <span className="text-red-700 animate-pulse">SEE
                  </span> THE UNSEEN
                  <br /> 
                </h1>
              ...
              {/* Right visuals */}
              <div className={`relative flex justify-center md:justify-end items-center pr-2 sm:pr-3 md:mr-2 lg:mr-6 xl:mr-10 transform transition-all duration-1000 delay-300 ${heroVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
                {/* Device image */}
                <img
                  src={final1}
                  alt="device"
                  className="relative z-10 block w-full max-w-[600px] sm:max-w-[700px] md:max-w-[820px] lg:max-w-[940px] xl:max-w-[1040px] max-h-[90vh] mx-auto md:mx-0 object-contain drop-shadow-[0_40px_120px_rgba(0,0,0,0.6)] origin-right scale-[1.1] md:scale-[1.14] hover:scale-110 transition-transform duration-500"
                />
              </div>
            </div>
          </div>
            ...
            <div className={`transform transition-all duration-1000 delay-200 ${featuresVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start gap-5 group hover:scale-105 transition-transform duration-300">
                  <div className="shrink-0 h-16 w-16 rounded-2xl bg-gradient-to-br from-red-600 to-red-500 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)] ring-1 ring-white/10 backdrop-blur-sm group-hover:shadow-red-900/50 transition-all duration-300">
                    <ShieldCheck className="h-8 w-8 text-white group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-5 group hover:scale-105 transition-transform duration-300">
                  <div className="shrink-0 h-16 w-16 rounded-2xl bg-gradient-to-br from-red-600 to-red-500 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)] ring-1 ring-white/10 backdrop-blur-sm group-hover:shadow-red-900/50 transition-all duration-300">
                  <ClipboardCheck className="h-8 w-8 text-white group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-5 group hover:scale-105 transition-transform duration-300">
                 ...
                 <div className="flex items-start gap-5 group hover:scale-105 transition-transform duration-300">
                  <div className="shrink-0 h-16 w-16 rounded-2xl bg-gradient-to-br from-red-600 to-red-500 p-4 shadow-[0_10px_30px_rgba(0,0,0,0.45)] ring-1 ring-white/10 backdrop-blur-sm group-hover:shadow-red-900/50 transition-all duration-300">
                    <MessageSquare className="h-8 w-8 text-white group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-6 md:px-10 lg:px-24 grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          <div className={`relative transform transition-all duration-1000 delay-300 ${promoVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}>
            ...
            <div className="hidden md:block">
              <div className="absolute -top-10 -right-6 h-28 w-28 rounded-full bg-gradient-to-br from-red-600 to-red-500 shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-white/10 backdrop-blur-sm grid place-items-center animate-[bounce_2s_infinite] hover:scale-110 transition-transform duration-300">
                <Shield className="h-10 w-10 text-white" />
              </div>
              <div className="absolute top-24 -right-4 h-28 w-28 rounded-full bg-gradient-to-br from-red-600 to-red-500 shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-white/10 backdrop-blur-sm grid place-items-center animate-[bounce_2s_infinite_0.5s] hover:scale-110 transition-transform duration-300">
                <Lock className="h-10 w-10 text-white" />
              </div>
              <div className="absolute -bottom-6 right-12 h-24 w-24 rounded-full bg-gradient-to-br from-red-600 to-red-500 shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-white/10 backdrop-blur-sm grid place-items-center animate-[bounce_2s_infinite_1s] hover:scale-110 transition-transform duration-300">
                <Fingerprint className="h-8 w-8 text-white" />
              </div>
              <div className="absolute bottom-24 right-44 h-24 w-24 rounded-full bg-gradient-to-br from-red-600 to-red-500 shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-white/10 backdrop-blur-sm grid place-items-center animate-[bounce_2s_infinite_1.5s] hover:scale-110 transition-transform duration-300">
          ...
          <div className={`relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-red-700 via-red-600 to-red-400 p-6 md:p-10 transform transition-all duration-1000 ${newsletterVisible ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
            ...
            <div className="relative grid items-center gap-6 md:gap-8 md:grid-cols-2">
              ...
              <form
                ...
                className={`w-full rounded-2xl sm:rounded-full bg-white/95 p-2 sm:pl-6 sm:pr-2 sm:py-2 shadow-lg ring-1 ring-black/5 flex flex-col sm:flex-row gap-2 sm:gap-0 transform transition-all duration-1000 delay-400 hover:scale-105 ${newsletterVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'}`}
              >
                <input
                  type="email"
                  required
